class ApuCreator {
    ...
    constructor(_id: string, apu_name: string, apu_unit: string, apu_price: number, apu_materials: CIDEINMaterials[], apu_equipment: CIDEINEquipment[], apu_description: string, apu_workHand: CIDEINWorkhand[], apu_transportation: CIDEINTransportation[], apu_apu: CIDEINAPU[], apu_chapter: string) {
        this._id = _id
        ...
        console.log('%c Hey, Hola!, Has empezado a Crear un APU, buena suerte! ', 'background: #FDBE33; color: #030F27; font-size: 1rem;')
    }
    ...
    calculateApuCost() {
        ...
        for (let i = 0; i < this.apu_transportation.length; i++) {
            ...
            const partialValue = currentTransportation.transportation_unitary_price * currentTransportation.transportation_amount * (1 + currentTransportation.transportation_rud)
    ...
    serializedTransportation() {
        ...
        for (let i = 0; i < this.apu_transportation.length; i++) {
            ...
            serializedTransp.push({ transportation_id: currentTransportation.transportation_code, transportation_amount: currentTransportation.transportation_amount })
        }

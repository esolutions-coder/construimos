...
export default function AddMaterialForm({handleSave}:AddMaterialProps){
    const [data, setData] = useState<CIDEINMaterials>({ _id: '' } as CIDEINMaterials);
        ...
        <div className="add_container my_sm_16">
            <form className="cidein_form_single" onSubmit={handleSubmit}>
              ...
              <div className="form_input_container">
                ...
                <input type="text" placeholder="Unidad" name="material_unit" value={data?.material_unit} onChange={handleChange}/>
              </div>
              <div className="form_input_container">
                <label htmlFor="material_rud">RUD</label>
                <input type="text" placeholder="Rendimiento / Desperdicio" name="material_rud" value={data?.material_rud} onChange={handleChange}/>
              </div>
              <div className="form_input_container">
              ...
              <div className="form_input_container">
                ...
                <input type="text" placeholder="Unidad" name="material_code" value={data?.material_code} onChange={handleChange}/>
              </div>
              <div className="form_input_container">
